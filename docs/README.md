...
| [demo/](demo/) | Six read-only queries for showing Huron what is in KC live, with what each one demonstrates and what to say while it runs. Includes how to handle the connectivity question, which is still D-18. |
