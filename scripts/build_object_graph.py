...
MODULES = {
    ...
    "subaward": {
        ...
        "root_table": "SUBAWARD",
        "root_pk_property": "subAwardId",
        "purpose": {
            "extension": "BU-specific extended Subaward attributes",
            "organization": "Subrecipient organization",
            "unit": "Requisitioner unit",
            "rolodex": "Site investigator (external contact)",
            "subAwardStatus": "Subaward status decode",
            "subAwardType": "Subaward type decode - reuses the AWARD_TYPE lookup",
            "subAwardCostType": "Cost type decode",
            "subAwardDocument": "KEW routing document header",
            "versionHistory": "Framework versioning bookkeeping",
            "subAwardFundingSourceList": "Awards funding this subaward",
            "subAwardAmountInfoList": "Obligated/anticipated money per modification",
            "subAwardContactsList": "People and organizations on the subaward",
            "subAwardCloseoutList": "Closeout checklist and dates",
            "subAwardCustomDataList": "BU custom attribute values (EAV)",
            "subAwardAttachments": "Attachment metadata",
            "subAwardTemplateAttachments": "Template attachment metadata",
            "subAwardReportList": "Required reports",
            "subAwardTemplateInfo": "Template/agreement terms captured per subaward",
            "subAwardFfataReporting": "FFATA reporting status",
            "subAwardNotifications": "Notification log",
            "amountReleasedList": "Invoice / amount released history",
        },
        "exclude": {
            "subAwardDocument": "KEW workflow routing header - platform infrastructure, not Grants data",
            "versionHistory": "framework versioning bookkeeping, not a business relationship",
            "subAwardNotifications": "notification send log - operational",
        },
        "core_entities": {"SUBAWARD"},
        "extra_edges": [{
            "relationship_name": "amountReleasedList",
            "relationship_type": "ONE_TO_MANY",
            "child_object": "SubAwardAmountReleased",
            "child_class": "org.kuali.kra.subaward.bo.SubAwardAmountReleased",
            "join_columns": "subAwardId",
            "business_purpose": "Invoice / amount released history",
            "expose": "Y",
            "notes": "not declared as a collection on SubAward; SUBAWARD_AMT_RELEASED "
                     "carries SUBAWARD_ID, SUBAWARD_CODE and SEQUENCE_NUMBER and KC "
                     "reaches it through the amount-released screen",
        }],
    },
    "proposal": {
